...
import { authorize, callback, confirmConsent, tokenExchangeCallback } from "mcp-auth0-oidc/src/auth";
import type { UserProps } from "mcp-auth0-oidc/src/types";

export class AuthenticatedMCP extends McpAgent<Env, Record<string, never>, UserProps> {
	server = new McpServer({
		name: "Unified Auth0 MCP Server",
		version: "1.0.0",
	});
